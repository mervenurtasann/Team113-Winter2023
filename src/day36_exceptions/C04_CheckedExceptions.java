...
public class C04_CheckedExceptions {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        /*
            ...
            Checked Exeptions genelde dosya okuma ve yazma b IO(input-output) islemlerinde olusur
            ...
            2- Eger exception'i handle etmek istemiyorsak
               ...
               ANCAK exception olusursa jaya'ya cozum yolu sunulmadigindan kodun calismasi durur
         */
