...
public class CAvciKuslar extends BKuslar {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(kartalAvci.cogalma); // B yurmutayla
        ...
        System.out.println(kartalKus.cogalma); // B yurmutayla

        System.out.println(kartalKus.omur); // A yasar ve olurler

        AHayvanlar kartalHayvan = new CAvciKuslar();
        System.out.println(kartalHayvan.hareket); // C ucarlar
        System.out.println(kartalHayvan.beslenme); // C et yerler
        ...
        System.out.println(kartalHayvan.omur);
