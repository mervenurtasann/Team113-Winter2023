...
public class C01_LocalTime {
    public static void main(String[] args) {
        ...
        System.out.println(saat); // 20:57:02.643

        // LocalTime objesi olan saat variable'i canli bir saat degildir
        // olusturuldugu andaki local time'i sistemden alip kaybettigimiz sabit bir degerdir
        ...
        System.out.println(saat.getHour()); // 21
        ...
        System.out.println(saat.compareTo(saat1)); // -1, ayni ise 0 doner

        System.out.println(saat.isAfter(saat1)); // true
        System.out.println(saat.isBefore(saat1)); // false

        System.out.println(saat.toSecondOfDay()); // 76505
    }
}
