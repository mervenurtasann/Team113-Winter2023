...
public class C01_TreeMapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // Varsa verilen key'den baslayip sona kadar yazar dondurur
        ...
        System.out.println(deneme.headMap("M")); // {T=30, Z=30}
        ...
        // deneme = deneme.descendingMap(); atama yapamıyoruz
