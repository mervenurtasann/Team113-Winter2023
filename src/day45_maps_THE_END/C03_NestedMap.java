...
public class C03_NestedMap {
    public static void main(String[] args) {
        ...
        */
        ...
        // ogrencieri ayri ayri map yapsak

        Map<String,String> ogrenciMap = new HashMap<>();
        ogrenciMap.put("Isim","Ali");
        ogrenciMap.put("Soyisim","Cem");
        ogrenciMap.put("Sinif","10");
        ogrenciMap.put("Sube","H");
        ogrenciMap.put("Bolum","MF");
