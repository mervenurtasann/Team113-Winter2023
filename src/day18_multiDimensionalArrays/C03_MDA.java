...
public class C03_MDA {
    public static void main(String[] args) {
        ...
        // ikinci [] ise icerdeki arrray'leri (innerArray) kontrol eder
        ...
        System.out.println(arr[1]); // [I@6e0be858

        System.out.println(Arrays.toString(arr[1])); // [2, 3]

        System.out.println(Arrays.toString(arr)); // [[I@61bbe9ba, [I@6e0be858, [I@610455d6]
