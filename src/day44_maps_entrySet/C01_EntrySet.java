...
public class C01_EntrySet {
    public static void main(String[] args) {
        ...
        /*
            ...
            1- map'deki tum key'leri okulMap.keySet() mehod'u ile elde edip birSet'e kaydederiz
                [101, 102, 103, 104, 105, 106]
            2- for-each loop ile her bir key'e ait value'yu aliriz
                "Ali-Cem-10-H-MF"
                - value.split() ile value'yu bir array'e cevirip kaydederiz
                [Ali, Cem, 10, H, MF]
                - bu array'de sinifi kontrol edip, eger istenen sinifa esit ise
                  key ve value array'inden istenen bilgileri yazdiririm

             Java key ve value degerleri birlikte kullanabilsin ve gerekirse
             value update edebilsin diye Entry interface'ini olusturmustur.
